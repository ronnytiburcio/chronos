...
Chronos/Storage   AppPaths (+ ArchiveLocation), JSONFile, AppStateStore (state.json), ProjectStore (projects.json), SessionLog (sessions.jsonl), CSV, ArchiveWriter, Exporter
